        ...
        rSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (varEmail.isEmpty()) {
                    ...
                    remail.setError("Email not Entered");
                    rpswd.setError("Password not Entered");
                    Toast.makeText(t_signUp.this, "Please Enter Email and Password", Toast.LENGTH_SHORT).show();
                } else if (!(varEmail.isEmpty() && varPassword.isEmpty())) {
                mFirebaseAuth.createUserWithEmailAndPassword(varEmail, varPassword).addOnCompleteListener(t_signUp.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {    //creating user using email and password
                        if (task.isSuccessful()) {
                            Toast.makeText(t_signUp.this, "New User Registered", Toast.LENGTH_SHORT).show(); //toast
                            startActivity(new Intent(t_signUp.this, t_login.class));
                        } else if (!task.isSuccessful())
                            Toast.makeText(t_signUp.this, "Registration Failed", Toast.LENGTH_SHORT).show();  //toast
                    }
                });
            }
            }
